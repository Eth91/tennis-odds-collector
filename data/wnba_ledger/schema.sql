CREATE TABLE IF NOT EXISTS predictions(
  ...
  result TEXT, actual REAL, graded INTEGER DEFAULT 0, basis TEXT, samples TEXT, confidence TEXT, played INTEGER DEFAULT 0, side TEXT DEFAULT 'over', regime TEXT, vol TEXT, spread REAL, pi_role REAL, actual_total REAL, actual_margin REAL, odds_other REAL, tier TEXT DEFAULT 'firm', peer_regime TEXT, peer_ramp TEXT, rungs TEXT,
